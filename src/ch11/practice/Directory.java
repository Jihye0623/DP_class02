...
public class Directory extends Entry {
    ...
    // 자기 내용물들을 관리하는 리스트 
    private List<Entry> directory = new ArrayList<>();  // Entry는 부모 타입. File을 담을 수도, Directory를 담을 수도
    // 원래는 new ArrayList<Entry>(); 해야하는데 컴파일러가 자동으로 처리함
